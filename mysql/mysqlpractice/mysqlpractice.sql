-- JOINING TABLES
-- JOIN 
-- Find al the clients (first and last name) billing amounts and charged date
...
-- Get the names of the clients, their domain names, and the firt names of all the leads generated from those sites.
